    ...
    <div className="grid w-full gap-4 mx-auto font-semibold bg-none">
      <div className="col-span-full mx-20">
        <p className="text-4xl leading-relaxed">
          ...
          <span className="font-mono bg-white">ReflexProof.sol</span> Contract
          Not Deployed on{" "}
        ...
        <p className="text-xl leading-relaxed mt-8">
          ...
          <span className="font-mono bg-white">action/frontend/abi</span>. To
          deploy <span className="font-mono bg-white">ReflexProof.sol</span> on
        ...
        <p className="font-mono text-2xl leading-relaxed bg-black text-white p-4 mt-12">
          <span className="opacity-50 italic text-red-500">
            #from &lt;project-root&gt;/action/contracts
          </span>
          <br />
